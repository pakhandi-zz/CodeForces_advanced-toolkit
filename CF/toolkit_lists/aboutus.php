...
<div class="back_body" id="back_body">
  ...
  <div class="pic6" id="pic6">
      <a href="https://www.facebook.com/mpsmks" target="_blank"><img src="http://codeforces.com/userphoto/title/mmaks/photo.jpg" height="190px" width="190px"></a>
  </div>

  <div id="name1">
    <a href="https://www.facebook.com/AsimKPrasad" target="_blank">Asim Krishna Prasad</a>
    </div>
  <div id="name2">
    <a href="https://www.facebook.com/mpsmks" target="_blank">Manish Kumar Sinha</a>
  </div>
  <div class="trans" id="trans">
    <center style="font-size: 20px;">
    We are a team of passionate, crazy & lazy night-crawlers <b>:P</b> <br>
